...
<h1>Thanks for registering!  Please enter your contact and account info below:</h1>
	<form action="confirmation" method="POST" onsubmit="return validate(first, last, email, phone, password, cPassword)">
		...
		<div id="emailDiv">
			Email: <input type="text" name="email" id="txtEmail" required> <br>
		</div>
		
		
		<div id="phoneNumDiv">
			Phone number: <input type="text" name="phone" id="txtPhone" required> <br>
		</div>
		
		Password: <input type="password" name="password" id="txtPassword" required> <br>
		
		<div id="cPswdDiv">
		Confirm password: <input type="password" name="cPassword" id="txtCPassword" required><br>
		</div>
